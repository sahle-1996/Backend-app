    ...
    try {
      ...
      if (!title || !author || !publishYear || !req.file) {
        return res
          ...
          .json({
            message:
              "Missing required fields: title, author, publish year, and image",
          });
      }
  ...
  try {
    ...
    if (!title || !author || !publishYear) {
      return res
        .status(400)
        .json({
          message: "Missing required fields: title, author, or publish year",
        });
    }
  ...
  try {
    ...
    if (!deletedBook) {
      return res
        ...
        .json({
          message:
            "Book not found or you are not authorized to delete this book.",
        });
    }
